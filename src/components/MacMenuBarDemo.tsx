      ...
      <AnimatePresence>
        {showPopover && (
          <motion.div
            ...
            className="w-72 ml-auto shadow-xl"
          >
            <div className="frame-block p-4 border-t-0 rounded-t-none">
              ...
              {stage !== "logged-in" ? (
                ...
                <div>
                  ...
                  >
                    ...
                    <p className="text-center text-[0.45rem] font-mono text-muted-ink/40 mt-2">
                ...
                >
                  ...
                  <div className="mt-3 pt-2.5 border-t border-warm-brown/15 text-[0.4rem] font-mono text-muted-ink/30 flex items-center justify-center gap-1">
                    <motion.span
